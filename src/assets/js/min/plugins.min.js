    ...
    var n = {
      ...
      handleClick: function(e) {
        var n = this,
          ...
          s = t(o.hash);
        e.preventDefault(),
        s.length && (n.clearTimer(), "function" == typeof n.options.beforeStart && n.options.beforeStart(), n.setActiveLink(o.hash), n.scrollTo(s,
          function() {
            n.options.updateHash && (i.location.hash = o.hash),
              n.setTimer(),
      ...
      setTimer: function() {
        var t = this;
        t.$window.on("scroll.singlePageNav",
          function() {
            t.didScroll = !0
          }),
      ...
      getCurrentSection: function(e) {
        var i, n, o, s;
        for (i = 0; i < this.$links.length; i++) n = this.$links[i].hash,
        t(n).length && (o = this.getCoords(t(n)), e >= o.top - this.options.threshold && (s = n));
      ...
      r = function() {
        for (var e = i.scrollTop(), r = n.height(), a = r - s, c = e > a ? a - e: 0, l = 0; l < o.length; l++) {
          ...
          if (u >= e) null !== h.currentTop && (h.stickyElement.css("position", "").css("top", ""), h.stickyElement.parent().removeClass(h.className), h.currentTop = null);
            ...
            0 > d ? d += h.topSpacing: d = h.topSpacing,
            h.currentTop != d && (h.stickyElement.css("position", "fixed").css("top", d), "undefined" != typeof h.getWidthFrom && h.stickyElement.css("width", t(h.getWidthFrom).width()), h.stickyElement.parent().addClass(h.className), h.currentTop = d)
          }
        }
      },
      a = function() {
